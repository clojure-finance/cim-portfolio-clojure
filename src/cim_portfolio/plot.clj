...
;; @@
;; =>
;;; {"type":"vega","content":{"width":800,"height":494.4376,"padding":{"top":10,"left":80,"bottom":50,"right":10},"data":[{"name":"989fbecd-5336-474a-a708-f07b6b422104","values":[{"x":0,"y":1000},{"x":1,"y":2000},{"x":2,"y":3000},{"x":3,"y":2000},{"x":4,"y":4000}]}],"marks":[{"type":"line","from":{"data":"989fbecd-5336-474a-a708-f07b6b422104"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"black"},"strokeWidth":{"value":3},"strokeOpacity":{"value":1}}}}],"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"989fbecd-5336-474a-a708-f07b6b422104","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"989fbecd-5336-474a-a708-f07b6b422104","field":"data.y"}}],"axes":[{"type":"x","scale":"x","title":"x-axis","titleOffset":40,"grid":true},{"type":"y","scale":"y","title":"y-axis","titleOffset":65,"grid":true}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 800, :height 494.4376, :padding {:top 10, :left 80, :bottom 50, :right 10}, :data [{:name \"989fbecd-5336-474a-a708-f07b6b422104\", :values ({:x 0, :y 1000} {:x 1, :y 2000} {:x 2, :y 3000} {:x 3, :y 2000} {:x 4, :y 4000})}], :marks [{:type \"line\", :from {:data \"989fbecd-5336-474a-a708-f07b6b422104\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"black\"}, :strokeWidth {:value 3}, :strokeOpacity {:value 1}}}}], :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"989fbecd-5336-474a-a708-f07b6b422104\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"989fbecd-5336-474a-a708-f07b6b422104\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\", :title \"x-axis\", :titleOffset 40, :grid true} {:type \"y\", :scale \"y\", :title \"y-axis\", :titleOffset 65, :grid true}]}}"}
;; <=
