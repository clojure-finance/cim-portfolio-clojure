...
(defn jt-parse-date [s]
  (LocalDate/parse s formatter))

(defn jt-compare-dates [d1 d2]
  (.compareTo (jt-parse-date d1) (jt-parse-date d2)))

(defn sort-map-by-date [m]
  (into (sorted-map-by jt-compare-dates) m))
