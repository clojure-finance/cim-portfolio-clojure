  ...
  [:div#summary.container
   ...
   [:div.card
    ...
    [:div.metrics
     ...
     [:div.metric [:span "Annualized Sharpe Ratio (1-year window):"] [:span#annualSharpe (if-let [v (data :annualized-sharpe-ratio)] (format "%.2f" v) "n/a — needs 21+ daily returns")]]
...
(defn portfolio-analytics-section [data]
  [:div#analytics.container
   ...
   [:div.card.full-width
    [:h2 "Annualized EWMA Sharpe Ratio (1-year window)"]
